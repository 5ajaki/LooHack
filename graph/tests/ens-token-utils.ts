...
export function createClaimEvent(claimant: Address, amount: BigInt): Claim {
...
export function createMerkleRootChangedEvent(
  merkleRoot: Bytes
): MerkleRootChanged {
  let merkleRootChangedEvent = changetype<MerkleRootChanged>(newMockEvent())

  merkleRootChangedEvent.parameters = new Array()

  merkleRootChangedEvent.parameters.push(
    new ethereum.EventParam(
      "merkleRoot",
